<template>
     <div>
        <h2 class="text-center mb-3">Add Customer</h2>
         <form @submit.prevent="customer_add()">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <img :src="form.cus_image" alt=""  class="img-fluid">
                                    <div v-if="!form.cus_image" class="custom-file">
                                        <input type="file" @change="onFileSelected" class="custom-file-input" id="cus_image">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-check">
                        <input class="form-check-input" v-model="form.status"  type="radio" name="publication_status" id="publication_status" value="1" checked>
                      ...
                      <div class="form-check">
                        <input class="form-check-input" v-model="form.status" type="radio" name="publication_status"  id="unpublished" value="0">
                        <!-- <has-error :form="form" field="publication_status"></has-error> -->
    ...
    methods:{
     ...
     if (file.size > 1048770) {
      ...
      reader.readAsDataURL(file);
        ...
        //          reader.onload = ()=>{
        //             this.form.cus_image = reader.result
